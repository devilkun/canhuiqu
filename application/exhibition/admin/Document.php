...
use app\exhibitionexhibitionexhibition\model\Column as ColumnModel;
use app\exhibitionexhibition\model\Document as DocumentModel;
...
class Document extends Admin
{
    ...
    public function index()
    {
        ...
        // 查询
        $map = $this->getMap();
        $map['exhibition_document.trash'] = 0;
        // 排序
        ...
        return ZBuilder::make('table')
            ->setSearch(['title' => '标题', 'exhibition_column.name' => '栏目名称']) // 设置搜索框
            ->addColumns([ // 批量添加数据列
                ['id', 'ID'],
                ['title', '标题'],
                ['column_name', '栏目名称'],
