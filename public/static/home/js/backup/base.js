			...
			(function(i) {
				...
				function k(t, e) {
					...
					var s = i.firstInput,
						...
						l = e.center = M(n);
					e.timeStamp = pe(), e.deltaTime = e.timeStamp - s.timeStamp, e.angle = N(r, l), e.distance = I(r, l), A(i, e), e.offsetDirection = P(e.deltaX, e.deltaY), e.scale = a ? L(a.pointers, n) : 1, e.rotation = a ? O(a.pointers, n) : 0, D(i, e);
					var d = t.element;
				...
				function A(t, e) {
					var i = e.center,
						...
						o = t.prevDelta || {},
						s = t.prevInput || {};
					(e.eventType === Ee || s.eventType === ke) && (o = t.prevDelta = {
						x: s.deltaX || 0,
						y: s.deltaY || 0
					}, n = t.offsetDelta = {
						x: i.x,
				...
				function D(t, e) {
					...
					if (e.eventType != Ae && (r > Ce || void 0 === a.velocity)) {
						var l = a.deltaX - e.deltaX,
							d = a.deltaY - e.deltaY,
							u = $(r, l, d);
						n = u.x, o = u.y, i = he(u.x) > he(u.y) ? u.x : u.y, s = P(l, d), t.lastInterval = e
				...
				function _() {
					this.evEl = We, this.evWin = He, C.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
				}
				...
				function R(t, e) {
					...
					return e & (ke | Ae) && (i = y(i.concat(n), "identifier", !0)), [i, n]
				}
				...
				function q(t, e) {
					var i = w(t.touches),
						n = this.targetIds;
					if (e & (Ee | Se) && 1 === i.length) return n[i[0].identifier] = !0, [i, i];
					...
					for (o = 0; o < a.length;) n[a[o].identifier] && r.push(a[o]), e & (ke | Ae) && delete n[a[o].identifier], o++;
				...
				function Q(t) {
					this.id = T(), this.manager = null, this.options = r(t || {}, this.defaults), this.options.enable = c(this.options.enable, !0), this.state = oi, this.simultaneous = {}, this.requireFail = []
				}
				...
				function ne(t, e) {
					return e = e || {}, e.recognizers = c(e.recognizers, ne.defaults.preset), new oe(t, e)
				}

				function oe(t, e) {
					e = e || {}, this.options = r(e, ne.defaults), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.element = t, this.input = E(this), this.touchAction = new H(this, this.options.touchAction), se(this, !0), s(e.recognizers, function(t) {
				...
				l(z, C, {
					handler: function(t) {
						var e = _e[t.type];
						e & Ee && 0 === t.button && (this.pressed = !0), e & Se && 1 !== t.which && (e = ke), this.pressed && this.allow && (e & ke && (this.pressed = !1), this.callback(this.manager, e, {
							pointers: [t],
							changedPointers: [t],
							pointerType: Te,
							srcEvent: t
				...
				window.MSPointerEvent && (We = "MSPointerDown", He = "MSPointerMove MSPointerUp MSPointerCancel"), l(_, C, {
					handler: function(t) {
						var e = this.store,
							i = !1,
						...
						o & Ee && (0 === t.button || a) ? 0 > r && (e.push(t), r = e.length - 1) : o & (ke | Ae) && (i = !0), 0 > r || (e[r] = t, this.callback(this.manager, o, {
							pointers: e,
							changedPointers: [t],
							pointerType: s,
							srcEvent: t
				...
				l(j, C, {
					handler: function(t) {
						...
						if (e === Ee && (this.started = !0), this.started) {
							...
							e & (ke | Ae) && i[0].length - i[1].length === 0 && (this.started = !1), this.callback(this.manager, e, {
								pointers: i[0],
								changedPointers: i[1],
								pointerType: ye,
								srcEvent: t
				...
				l(U, C, {
					...
					handler: function(t, e, i) {
						...
						e & (ke | Ae) && (this.mouse.allow = !0), this.callback(t, e, i)
					},
					destroy: function() {
				...
				Q.prototype = {
					...
					getTouchAction: function() {
						var t = this.options.direction,
							e = [];
						return t & Ie && e.push(ni), t & Ne && e.push(ii), e
					},
					directionTest: function(t) {
						var e = this.options,
							...
							s = t.deltaX,
							a = t.deltaY;
						return o & e.direction || (e.direction & Ie ? (o = 0 === s ? De : 0 > s ? Fe : Me, i = s != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === a ? De : 0 > a ? $e : Pe, i = a != this.pY, n = Math.abs(t.deltaY))), t.direction = o, i && n > e.threshold && o & e.direction
					},
					attrTest: function(t) {
					...
					attrTest: function(t) {
						...
						return i & (Ie | Ne) ? e = t.velocity : i & Ie ? e = t.velocityX : i & Ne && (e = t.velocityY), this._super.attrTest.call(this, t) && i & t.direction && t.distance > this.options.threshold && he(e) > this.options.velocity && t.eventType & ke
					},
					emit: function(t) {
						var e = X(t.direction);
...
! function(e) {
	...
	a.api = {
		...
		var a = new Date(1e3 * e),
			...
			r = a.getHours(),
			i = a.getMinutes();
		return 10 > n && (n = "0" + n), 10 > o && (o = "0" + o), 10 > r && (r = "0" + r), 10 > i && (i = "0" + i), "" + t + "-" + n + "-" + o + " " + r + ":" + i
	}, a.getYMD = function(e) {
		var a = e.getMonth() + 1,
			t = e.getDate();
		return a = 10 > a ? "0" + a : a, t = 10 > t ? "0" + t : t, e.getFullYear() + "-" + a + "-" + t
	}, a.getHHMM = function(e) {
		var a = e.getHours(),
			t = e.getMinutes();
		return a = 10 > a ? "0" + a : a, t = 10 > t ? "0" + t : t, a + ":" + t
		...
		return {
			info: function(e, a, t, n, o) {
				...
				$("body").append(r), $("#J-tipMsg").modal({
					relatedTarget: this,
					closeViaDimmer: !1,
					onConfirm: function() {
						o && o(), $("#J-tipMsg").modal("close"), setTimeout(function() {
							$("#J-confirm").remove()
						}, 300)
					}
				}), $("#J-tipMsg").on("closed.modal.amui", function() {
					$("#J-tipMsg").remove()
				})
			},
			modal: function(e, a, t) {
				$("body").append(e), $(a).modal({
					relatedTarget: this,
					closeViaDimmer: !1,
					onConfirm: function() {
						t && t(), $(a).modal("close"), setTimeout(function() {
							$("#J-confirm").remove()
						}, 300)
					}
				}), $(a).on("closed.modal.amui", function() {
					$(a).remove()
				})
			},
			confirm: function(e, a, t, n, o) {
				...
				$("body").append(r), $("#J-confirm").modal({
					relatedTarget: this,
					onConfirm: function() {
						o && o(), $("#J-confirm").modal("close"), setTimeout(function() {
							$("#J-confirm").remove()
						}, 300)
					}
				}), $("#J-confirm").on("closed.modal.amui", function() {
					$("#J-confirm").remove()
				})
			}
		}
		...
		easeInBack: function(e, a, t, n, o, r) {
			return void 0 == r && (r = 1.70158), n * (a /= o) * a * ((r + 1) * a - r) + t
		},
		easeOutBack: function(e, a, t, n, o, r) {
			return void 0 == r && (r = 1.70158), n * ((a = a / o - 1) * a * ((r + 1) * a + r) + 1) + t
		},
		easeInOutBack: function(e, a, t, n, o, r) {
			return void 0 == r && (r = 1.70158), (a /= o / 2) < 1 ? n / 2 * a * a * (((r *= 1.525) + 1) * a - r) + t : n / 2 * ((a -= 2) * a * (((r *= 1.525) + 1) * a + r) + 2) + t
		},
		...
		function a(a) {
			var t = {},
				n = /^jQuery\d+$/;
			return e.each(a.attributes, function(e, a) {
		...
		function t(a, t) {
			var n = this,
				r = e(n);
			if (n.value == r.attr("placeholder") && r.hasClass(p.customClass))
				if (r.data("placeholder-password")) {
					...
					r.focus()
				} else n.value = "", r.removeClass(p.customClass), n == o() && n.select()
		}
		...
		function n() {
			...
			if ("" === o.value) {
				...
				r.addClass(p.customClass), r[0].value = r.attr("placeholder")
		...
		if (u && d) i = e.fn.placeholder = function() {
			...
			}, u || (c.input = r, l.value = r), d || (c.textarea = r, l.value = r), e(function() {
	...
	}), e.bandeng = a, $(document.body).ready(function() {
		var e = $(".h-user"),
			a = e.find(".u-menu");
		e.delegate(".u-vatar,.u-menu", "mouseenter", function() {
			a.stop(), a.fadeIn(200)
		}), e.delegate(".u-vatar,.u-menu", "mouseleave", function() {
			a.stop(), a.fadeOut(200)
		}), $("input, textarea").placeholder(), $(".wx-tabs").delegate("a", "click", function(e) {
			e.preventDefault();
			var a = $(this),
				t = a.index(),
				n = $(".wx-content");
			a.addClass("on"), a.siblings("a").removeClass("on"), n.find("p").hide(), n.find("p").eq(t).show()
		});
		var t = 0,
			n = 0;
		$(window).scrollTop() >= 55 && $("#bd-header").removeClass("p-header-show").addClass("p-header-hide"), $(window).scrollTop() < 55 && $("#bd-header").removeClass("p-header-hide").addClass("p-header-show"), $(window).scroll(function() {
			n = $(window).scrollTop(), t > n ? $(window).scrollTop() < 55 && ($("#bd-header").removeClass("p-header-hide").addClass("p-header-show"), $(".bd-wraper").css({
				marginTop: "55px"
