(function() {
	var h = {},
		mt = {},
		c = {
			id: "a4c6a1146b6735a7a5201198d2f6a0c8",
			dm: ["bandenghui.com"],
	...
	mt.f.M = function(a, b) {
		...
		if (!a) return g;
		for (; a.parentNode != t;) {
			for (var f = 0, p = 0, n = a.parentNode.childNodes.length, e = 0; e < n; e++) {
			...
			if ((n = "" !== a.id) && b) {
				...
				break
			} else n && (n = "#" + encodeURIComponent(a.id), n = 0 < d.length ? n + ">" + d.join(">") : n, g.push(n)), d.unshift(encodeURIComponent(String(a.nodeName).toLowerCase()) + (1 < f ? "[" + p + "]" : ""));
			a = a.parentNode
		}
		g.push(d.join(">"));
		return g
		...
		return function(d) {
			switch (typeof d) {
				...
				default:
					...
					if (d instanceof Array) {
						...
						for (e = 0; e < p; e++) switch (l = d[e], typeof l) {
							...
							case "unknown":
								break;
							default:
								n && f.push(","), f.push(mt.l.stringify(l)), n = 1
						}
						f.push("]");
						return f.join("")
					}
					...
					e = mt.l.stringify;
					for (p in d)
						if (Object.prototype.hasOwnProperty.call(d, p)) switch (l =
							d[p], typeof l) {
							case "undefined":
							case "unknown":
							case "function":
	...
	(function() {
		var a = mt.f,
			...
			n = {
				fa: function() {
					c.ctrk && (d.c(document, "mouseup", n.ma()), d.c(window, "unload", function() {
						n.G()
				...
				ya: function(d) {
					...
					m.push(d.hb);
					m.push(d.Ia);
					(l = "a" === (l.tagName || "").toLowerCase() ? l : a.xa(l)) ? (m.push("a"), m.push(b.h(encodeURIComponent(l.href)))) : m.push("b");
					return m.join("*")
				},
				Ca: function(d, l, k, b) {
					d = a.Fa(l);
					var m = 0,
						...
						f = 0,
						w = 0;
					if (l && (m = l.offsetWidth || l.clientWidth, q = l.offsetHeight || l.clientHeight, w = a.Da(l), f = w.left, w = w.top, "html" === (l.tagName || "").toLowerCase())) m = Math.max(m, l.clientWidth), q = Math.max(q, l.clientHeight);
					return {
						Ra: Math.round(100 * ((k -
							f) / m)),
	...
	(function() {
		...
		function b() {
			...
			if ((!n || !l) && e && k) x = s, m = +new Date;
			else if (n && l && (!e || !k)) x = u, q += +new Date - m;
			n = e;
			l = k;
			y = setTimeout(b, 100)
		}
		...
		function d(a) {
			...
			if (a in l) m = a;
				...
				for (var d = ["webkit", "ms", "moz", "o"], k = 0; k < d.length; k++) {
	...
	(function() {
		function a(a, d, b, m) {
			if (!(a === r || d === r || m === r)) {
				...
				a = String(a).split("!");
				for (var q, f = u, e = 0; e < a.length; e++)
					if (q = a[e].split("*"), String(d) === q[0]) {
						q[1] = b;
						q[2] = m;
						a[e] = q.join("*");
						f = s;
			...
			e = {
					...
					if (!a || d.d(a, "Array")) window._hmt = {
						...
						push: function() {
							for (var a = window._hmt, l = 0; l < arguments.length; l++) {
								var m = arguments[l];
								d.d(m, "Array") && (a.cmd[a.id].push(m), "_setAccount" === m[0] && (1 <
									m.length && /^[0-9a-f]{32}$/.test(m[1])) && (m = m[1], a.id = m, a.cmd[m] = a.cmd[m] || []))
							}
						}
				...
				ta: function() {
					...
					if (a && a.cmd && a.cmd[c.id])
						for (var d = a.cmd[c.id], b = /^_track(Event|MobConv|Order|RTEvent)$/, m = 0, q = d.length; m < q; m++) {
							var f = d[m];
				...
				ua: function() {
					if (0 < e.s.length)
						for (var a = 0, d = e.s.length; a < d; a++) e.P(e.s[a]);
					e.s = t
				},
				P: function(a) {
					var b = a[0];
				...
				_setAutoPageview: function(a) {
					if (1 < a.length && (a = a[1], u === a || s === a)) e.e |= 2, h.b.Y = a
				},
				...
				_trackEvent: function(a) {
					2 < a.length && (e.e |= 8, h.b.a.nv =
						0, h.b.a.st = 4, h.b.a.et = 4, h.b.a.ep = d.h(a[1]) + "*" + d.h(a[2]) + (a[3] ? "*" + d.h(a[3]) : "") + (a[4] ? "*" + d.h(a[4]) : ""), h.b.k())
				},
				...
				_setReferrerOverride: function(a) {
					1 < a.length && (h.b.a.su = a[1].charAt &&
						"/" === a[1].charAt(0) ? f.protocol + "//" + window.location.host + a[1] : a[1], e.$ = s)
				},
				...
				_trackRTEvent: function(a) {
					...
					if (d.d(a,
						...
						if (900 >= n) k.call(this, a);
							...
							for (var n = Math.ceil(n / 900), m = "block|" + Math.round(Math.random() * f.w).toString(16) + "|" + n + "|", q = [], p = 0; p < n; p++) q.push(p), q.push(a.substring(900 * p, 900 * p + 900)), k.call(this, m + q.join("|")), q = []
					}
				},
	...
	(function() {
		function a() {
			"undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = s, this.a = {}, this.Y = s, this.N = u, this.init())
		}
		var b = mt.url,
			d = mt.da,
			g = mt.S,
		...
		a.prototype = {
			...
			L: function() {
				for (var a = document.location.hostname, d = 0, b = c.dm.length; d < b; d++)
					if (this.O(a, c.dm[d])) return c.dm[d].replace(/(:\d+)?[\/\?#].*/, "");
				return a
			},
			W: function() {
			...
			Za: function() {
				...
				if (0 === c.nv && this.C(document.location.href) &&
					("" === document.referrer || this.C(document.referrer))) a = 0, d = 4;
				this.a.nv = a;
				this.a.st = d;
				this.a.cc = b;
				this.a.lt = f;
			...
			init: function() {
				try {
					this.$a(), 0 === this.a.nv ? this.Ya() : this.R(".*"), h.b = this, this.la(), v.A("pv-b"), this.Xa()
				} catch (a) {
					var b = [];
					b.push("si=" + c.id);
			...
			la: function() {
				...
				a && (d.test(a) && f && g) && (this.a.rnd = Math.round(Math.random() * k.w), a = document.createElement("script"), a.setAttribute("type",
					"text/javascript"), a.setAttribute("charset", "utf-8"), a.setAttribute("src", k.protocol + "//" + c.js + e + ".js?" + this.a.rnd), e = document.getElementsByTagName("script")[0], e.parentNode.insertBefore(a, e))
			},
			ha: function(a) {
			...
			R: function(a) {
				...
				b && (a = encodeURIComponent(a.replace(/^https?:\/\//, "")),
					a = RegExp(a.replace(/([\*\(\)])/g, "\\$1") + "(%26u%3D[^,]*)?,?", "g"), (b = b.replace(a, "").replace(/,$/, "")) ? l.set("Hm_unsent_" + c.id, b) : l.remove("Hm_unsent_" + c.id))
			},
			Ya: function() {
				var a = this,
				...
				if (b)
					for (var b = b.split(","), f = function(b) {
							d.log(k.F + "//" + decodeURIComponent(b), function(b) {
								a.R(b)
							})
			...
			if (window.performance && performance.timing && "undefined" !== typeof h.b) {
				...
				var e = function() {
					...
					var l = a.match(/^(http[s]?:\/\/)?([^\/]+)(.*)/) || [],
						x = t;
					b = t;
					if ("www.baidu.com" === l[2] || "m.baidu.com" === l[2]) x = d.g(a, "qid"), b = d.g(a, "click_t");
					a = x;
					e.qid = a != t ? a : "";
	...
	(function() {
		...
		if ("undefined" !== typeof h.b && (c.med || (!a.Z || 7 < a.Pa) && c.cvcc)) {
			...
			if (c.med) p = "/zoosnet", f = "swt", n = /swt|zixun|call|chat|zoos|business|talk|kefu|openkf|online|\/LR\/Chatpre\.aspx/i, e = {
				click: function() {
				...
				e = {
					click: function() {
						for (var a = [], b = l(document.getElementsByTagName("a")), b = [].concat.apply(b, l(document.getElementsByTagName("area"))), b = [].concat.apply(b, l(document.getElementsByTagName("img"))), d, e, f, g = 0, k = b.length; g < k; g++) d = b[g], n !== r ? (e = d.getAttribute("onclick"), f = d.getAttribute("href"), m ? (d = d.getAttribute("id"), (n.test(e) || n.test(f) || m.test(d)) &&
							a.push(b[g])) : (n.test(e) || n.test(f)) && a.push(b[g])) : m !== r && (d = d.getAttribute("id"), m.test(d) && a.push(b[g]));
						return a
					}
				}
			}
			if ("undefined" !== typeof e && "undefined" !== typeof n) {
				...
				p += /\/$/.test(p) ? "" : "/";
				var x = function(a, d) {
					if (q === d) return v(p + a, d), u;
					if (b.d(d, "Array") || b.d(d, "NodeList"))
						for (var e = 0, f = d.length; e < f; e++)
							if (q === d[e]) return v(p + a + "/" + (e + 1), d[e]), u
				};
	...
	(function() {
		...
		if ("undefined" !== typeof h.b && b.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
			var f = {
				ga: function() {
					for (var b = c.cvcf.length, g, e = 0; e < b; e++)(g = a.wa(decodeURIComponent(c.cvcf[e]))) && d.c(g, "click", f.sa())
				},
				sa: function() {
					return function() {
						h.b.a.et = 86;
