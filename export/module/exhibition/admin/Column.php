...
use app\exhibition\model\Model as DocumentModel;
use app\exhibition\model\Column as ColumnModel;
use app\exhibition\model\Document;
...
//            ->addRightButton('custom', $btnMove)
    ...
    public function add($pid = 0)
    {
        ...
        $template_list   = File::get_dirs(APP_PATH.'exhibition/view/column/')['file'];
        $template_detail = File::get_dirs(APP_PATH.'exhibition/view/document/')['file'];
