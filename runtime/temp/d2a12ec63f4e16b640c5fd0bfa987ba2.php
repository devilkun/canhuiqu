<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"D:\phpStudy\PHPTutorial\WWW\test.cc\public/../application/user/view/admin/publics\signin.html";i:1521690133;}*/ ?>
<!DOCTYPE html>
...
<!--[if gt IE 9]><!--> <html class="no-focus" lang="zh"> <!--<![endif]-->
    ...
    <body>
        <!-- Login Content -->
        <div  >
            <img style="position:absolute;left:0px;top:0px;width:100%;height:100%;z-Index:-1; border:1px solid blue" src="/static/admin/img/banner_1.jpg" />
                    ...
                    <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                        <div class="push-30-t push-50 animated fadeIn">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-muted push-15-t">&nbsp;参会去会展活动信息平台</p>
                            </div>
                            <!-- END Login Title -->
        ...
        <script src="/static/admin/js/core/jquery.min.js"></script>
         <script src="/static/admin/js/core/jquery.SuperSlide.2.1.2.js"></script>
