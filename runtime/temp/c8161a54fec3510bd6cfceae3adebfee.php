<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:102:"D:\phpStudy\PHPTutorial\WWW\test.cc\application/../application/index/view/booth_construction\book.html";i:1523326603;s:74:"D:\phpStudy\PHPTutorial\WWW\test.cc\application\index\view\Public\nav.html";i:1524040551;s:77:"D:\phpStudy\PHPTutorial\WWW\test.cc\application\index\view\Public\footer.html";i:1524186740;}*/ ?>
<!DOCTYPE html>
...
<section class="details-titBox">
    <div class="details-mid">
        <div class="details-left fl">
            ...
            <a href="<?php echo url('BoothConstruction/book',['id' => $list['id']]); ?>" class="left-actvie">展台搭建</a>
    ...
    <div class="con-left fl">
        ...
        <div class="zh-company clearfix">
            <div class="company-title">
                ...
                <div class="tit-02">如果您需要展台搭建，请填写如下信息，我们的客户专员将在24小时内联系您</div>
            </div>
            <div class="custom-table">
                ...
                <div class="con-box introduce" style="border:1px solid #ff8a00;margin-top:10px;">
                    <div class="not-support">
                        <span style="color: #ff8a00">商家账户暂不支持展台搭建服务</span>
                    </div>
                </div>
                <?php else: ?>
                <form>
                    <ul>
                        <li>
                            ...
                            <div class="form-box fl">
                                <input class="form-control" type="text" style="width: 305px;"> m2
                            </div>
                        </li>
                        <li>
                            <div class="form-tit fl">
                        ...
                        <li>
                            ...
                            <div class="form-box fl">
                                <input class="form-control" type="text" style="width: 305px;">元 <span class="zs">(如没有预算,可不填)</span>
                            </div>
                        </li>
                        <li>
                            <div class="form-tit fl">
                            ...
                            <div class="form-box fl">
                                <textarea class="form-control other-yq" placeholder="您可以在这里详细说明您对展装的要求，比如：颜色，风格，高度，展位配置等。您的说明越详细，我们越能设计出满足您的需求的设计方案。"></textarea>
                            </div>
                        </li>
                        <li>
                            <div class="form-tit fl">
